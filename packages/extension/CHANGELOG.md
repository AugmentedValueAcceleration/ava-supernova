...
## 0.98.1 — 2026-09-07 — A task card that said "Added" and added nothing
...
- Credits page (`avasupernova.com/credits`) + pricing FAQ + `seo.ts` schema.org Offer descriptions all updated to the recalibrated numbers. The pre-rebalance 1,500 / 15,000 / 40,000 / 100,000 credit allowances were still in the SEO data despite the 2026-04-23 plan rebalance.
