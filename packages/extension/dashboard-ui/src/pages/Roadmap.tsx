...
const themes: RoadmapTheme[] = [
  {
    ...
    items: [
      { label: 'Core agent loop with 54 tools', shipped: true },
      ...
      { label: 'Per-turn memory injection', shipped: true },
      { label: 'Knowledge packs (7 built-in)', shipped: true },
      { label: 'Self-improvement vault', shipped: true },
      { label: 'Work mode persona activation', shipped: true },
      { label: 'Multi-agent collaboration', shipped: false },
      { label: 'Qwen Omni models (multimodal, vision, audio)', shipped: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: '7 providers, 14 models', shipped: true },
      { label: 'Qwen 3.5 Omni Plus + Omni Flash (default)', shipped: true },
      { label: '3M free tokens for all', shipped: true },
      { label: 'Creative studio', shipped: true },
