...
const themes: RoadmapTheme[] = [
  {
    ...
    items: [
      { label: 'Core agent loop with 60 tools', shipped: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Tool-call blocks — top-level stream elements with inline diff views for edits', shipped: true },
      { label: 'Context bar — real-time token usage indicator at top of chat, click to compress', shipped: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'AI-era learning paths', shipped: true },
