 ...
 *
 * Every target here pre-fills in one click. None of them need a clipboard hack.
 */
    ...
    <div ref={containerRef} className="w-full pb-12">
      ...
      <div className="mb-6 flex flex-wrap items-center gap-2">
        {shareTargets(article.title, articleUrl).map(target => (
          ...
          >
            {target.key === 'mu' ? (
              <img src={MU_ICON} alt="" className="h-3 w-3 rounded-[3px]" />
            ) : (
