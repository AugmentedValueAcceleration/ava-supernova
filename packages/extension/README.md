...
| **Longxiang** 龙翔 | **Ships now** | Kimi K3 | Kimi K3 (Builder) · Qwen 3.7 Plus (vision + long context + teach) · DeepSeek V4 Flash (chat + brainstorm + image-gen + intent gate) | Moonshot + Alibaba + DeepSeek |
...
Ava approaches your features the way a real engineer would, not the way a fast autocomplete does.
...
## As Your Security Auditor

Security mode runs a full OWASP-aligned scan with five specialist personas:

1. **Recon** — maps your attack surface (entry points, dependencies, auth model)
...
**Custom personality** — same brain, your style:

- **Name** — call her Ava, or anything else
