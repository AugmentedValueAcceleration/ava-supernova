...
- **52 built-in tools** — File ops, search, git, shell, web, browser, database, screenshots, planning, memory
...
- **Six modes** — Work (`>>` builder), Plan (`::` architect), Chat (`..` friend), Teach (`??` personal tutor), Security (`!!` OWASP audit), Brainstorm (`**` ideation)
