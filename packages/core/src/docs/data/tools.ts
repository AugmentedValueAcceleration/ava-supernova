...
export const TOOLS: ToolFact[] = [
  ...
  { name: 'generate_video', category: 'media', description: 'Generate a short AI video from a text prompt via Wan.', risk: 'write' },
  { name: 'generate_voice', category: 'media', description: 'Generate AI voice/speech from text via Qwen3-TTS.', risk: 'write' },
