...
export const START_PAGES: DocPage[] = [
  ...
  },
  {
    ...
    deeper: [
      ...
      { type: 'paragraph', text: 'Supernova — a frontier coordinator (DeepSeek Flash, 1.6T parameters / 49B active, 1M context) hands each subtask to a specialist: V4 Flash for high-volume review, Qwen 3.7 Plus for building and for vision (it sees images and video natively).' },
