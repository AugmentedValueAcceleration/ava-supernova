...
export const CONCEPT_PAGES: DocPage[] = [
  {
    ...
    deeper: [
      ...
      { type: 'table',
        ...
        rows: [
          ['Coordinator',     'Qwen 3.7 Plus',           'DeepSeek Flash (1.6T / 49B active, 1M ctx)',  'Mistral Medium 3.5 (128B dense, 256K ctx)'],
          ['Builder',         'Qwen 3.7 Plus (reuses coordinator)', 'Qwen 3.7 Plus',                     'Mistral Medium 3.5 (128B dense, 256K ctx)'],
          ['Mid-tier specialists', '—',                    'DeepSeek Flash (code reviewer, fact checker, recon, scanner, security verifier, etc.)', 'Mistral Small 4 (Verifier, Sequencer, recon, scanner, reporter)'],
          ...
          ['Chat',            'Qwen 3.5 Flash',           'DeepSeek Flash',                           'Mistral Small 4'],
  ...
  },
  {
    ...
    body: [
      ...
      { type: 'list', ordered: false, items: [
        ...
        '3.22× — Qwen 3.7 Max.',
        '3.12× — Mistral Medium 3.5 (Aurora\'s lead coordinator), at its $1.50/$7.50 frontier-flagship rate. This is the model the whole table is calibrated against.',
        '2.58× — Qwen 3.8 Max. Newer and better than 3.7 Max, and cheaper to you, because Alibaba cut the price — that is not how this usually goes, so it is worth saying out loud.',
        '1.68× — Kimi K2.7 Code.',
        '1.35× — DeepSeek Flash (Supernova coordinator). Raised from 0.66× when DeepSeek repriced on 16 August 2026, using our own logged traffic rather than the headline rate.',
        ...
        '0.82× — Qwen 3.7 Plus (Maestro coordinator). Raised from 0.51×: measured against real usage, it had been charging well under what it costs to run.',
        '0.44× — DeepSeek Flash. Note this went DOWN — the first pass after the August repricing set it too high, and measuring it properly brought it back below where it started.',
        '0.44× — Qwen 3.5 Plus, Qwen 3.5 Omni Plus.',
        '0.29× — Qwen 3.5 Omni Flash.',
        '0.22× — Qwen 3.5 Flash.',
