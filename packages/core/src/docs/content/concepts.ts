  ...
  },
  {
    ...
    body: [
      ...
      { type: 'list', ordered: false, items: [
        ...
        '1.68× — Kimi K2.7 Code.',
        '1.03× — DeepSeek V4 Pro (Supernova coordinator). Raised from 0.66× when DeepSeek repriced on 16 August 2026; the new figure comes from re-pricing our own logged traffic hour by hour, not from the headline rate.',
        ...
        '0.62× — DeepSeek V4 Flash. Also raised on 16 August 2026, from 0.37×.',
        '0.51× — Qwen 3.7 Plus (Maestro coordinator).',
