...
export const CONCEPT_PAGES: DocPage[] = [
  {
    ...
    body: [
      ...
      { type: 'paragraph', text: 'Two-model system, light footprint. Qwen 3.6 Plus drives the coordinator and Builder; Qwen 3.5 Flash handles the upstream intent gate plus any light-tier Conductor personas. Production-tuned, proven across months of operator workloads, the default on every plan. Falls through the priority ladder Qwen 3.6 Plus → 3.5 Plus → 3.5 Flash if the primary coordinator is unavailable.' },
