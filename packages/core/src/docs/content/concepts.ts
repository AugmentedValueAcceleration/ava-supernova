  ...
  },
  {
    ...
    body: [
      ...
      { type: 'list', ordered: false, items: [
        ...
        '1.68× — Kimi K2.7 Code.',
        '1.35× — DeepSeek V4 Pro (Supernova coordinator). Raised from 0.66× when DeepSeek repriced on 16 August 2026, using our own logged traffic rather than the headline rate.',
        ...
        '0.44× — DeepSeek V4 Flash. Note this went DOWN — the first pass after the August repricing set it too high, and measuring it properly brought it back below where it started.',
