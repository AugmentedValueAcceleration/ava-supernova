...
export class ModelRouter {
  ...
  private resolveAnyModel(reason: string): RouteResult | null {
    ...
    const byokModels = ['kimi-k2.6', 'claude-opus-4-8', 'claude-sonnet-4-6', 'kimi-k2.5', 'deepseek-chat', 'glm-5', 'mistral-large-3', 'qwen3.5-omni-plus', 'qwen3.5-omni-flash', 'qwen3.5-flash'];
