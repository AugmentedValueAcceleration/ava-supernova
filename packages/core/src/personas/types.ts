...
export type PersonaId = 'researcher' | 'architect' | 'builder' | 'recon' | 'scout' | 'verifier' | 'sequencer' | 'challenger' | 'brainstorm_challenger' | 'tutor' | 'quiz_master' | 'content_writer' | 'explorer' | 'ideator' | 'refiner' | 'curriculum_architect' | 'fact_checker' | 'scanner' | 'security_reporter' | 'tester' | 'code-reviewer' | 'design-reviewer' | 'curator';
