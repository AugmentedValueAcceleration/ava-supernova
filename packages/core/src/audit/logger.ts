...
/** Aggregate stats across the corpus — drives the cost-attribution view
 *  ("top 10 most expensive tool calls") + the pattern-detection panel
 *  ("you auto-approve bash but 23% fail"). Computes everything from a
 *  single pass over the filtered entries. */
