...
- **You pick a voice** from the roster: Cherry (sunny, friendly — the default), Serena (gentle, warm), Vivian (confident, feisty), Maia (intellect + gentleness), Bellona (powerful, heroic), Ethan (warm, energetic), Moon (bold, handsome), Vincent (raspy, cinematic), Neil (news-anchor precision), Kai (soothing).
