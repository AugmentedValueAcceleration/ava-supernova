...
export const enStrings: Record<string, string> = {
  ...
  'dash.library.subtitle': 'Images, documents, presentations, and spreadsheets created by Ava',
  'dash.library.all': 'All',
  'dash.library.images': 'Images',
  'dash.library.docs': 'Docs',
  'dash.library.sheets': 'Sheets',
  'dash.library.slides': 'Slides',
  ...
  'dash.library.ask_ava': 'Ask Ava to create images, documents, presentations, or spreadsheets',
  ...
  'dash.library.presentation': 'presentation',
  ...
  'dash.docs.library_intro': 'Browse images, documents, presentations, and spreadsheets created by Ava. Access from the Dashboard sidebar.',
  ...
  'weather.thunderstorm_heavy_hail': 'Thunderstorm with Heavy Hail',
  'weather.unknown': 'Unknown',
  'weather.humidity': 'Humidity',
  'weather.wind': 'Wind',
