...
export const enStrings = {
  ...
  'dash.settings.section.projects': 'Projects',
  'dash.settings.projects_home': 'Projects folder',
  'dash.settings.projects_home_hint': 'Where Ava creates new projects. Leave empty for the default — a visible folder in your home directory, deliberately not inside the hidden .ava data folder.',
  'dash.settings.browse': 'Browse…',
  'dash.settings.projects_home_reset': 'Reset',
  ...
  'storage.your_projects': 'Your projects',
  'storage.folders': 'folders',
  'storage.not_measured': 'not measured yet',
  ...
  'dash.model.supernova_title': 'Supernova — DeepSeek V4.1 Flash coordinating and specialising, with Qwen builders. Heavy multi-step work.',
  ...
  'health.browse.going_further': 'Going further',
  ...
  'health.submit.ex_advanced_label': 'Going further (optional)',
  'health.submit.ex_advanced_ph': 'Tempo, load and rep guidance, how to progress, variations.',
  ...
  'health.submit.ex_advanced_label_short': 'Going further',
  ...
  'doc.open_title': 'Open a document',
  'doc.open_placeholder': 'Search documents and spreadsheets…',
  'doc.recent': 'Recent',
  'doc.browse': 'Browse…',
  'doc.none_found': 'No documents in this project yet.',
  'doc.no_match': 'Nothing matches that.',
  'doc.switch': 'Switch',
  'doc.close': 'Close',
  'doc.loading': 'Opening…',
  'doc.saving': 'Saving…',
  'doc.unavailable': 'This file can\'t be opened — it may have been moved or deleted.',
  ...
  'library.reveal': 'Open in folder',
  'library.formats': 'Formats',
  'chat.jump_to_latest': 'Jump to latest',
  'library.show_source': 'Show .md',
  'library.show_source_title': 'Show the Markdown source alongside each document',
  'library.source_only': 'source only',
  ...
  'library.delete_confirm_title': 'Delete {name}?',
  'library.delete_confirm_one': 'This file is removed from disk. It cannot be undone.',
  'library.delete_confirm_many': 'All {count} files are removed from disk. It cannot be undone.',
